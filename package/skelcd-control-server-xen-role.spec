#
# spec file for package skelcd-control-server-xen-role
#
...
#   https://github.com/yast/skelcd-control-server-xen-role repository
#
...
Name:           skelcd-control-server-xen-role
# xmllint (for validation)
BuildRequires:  libxml2-tools
# RNG validation schema
BuildRequires:  yast2-installation-control >= 4.0.0

Url:            https://github.com/yast/skelcd-control-server-xen-role
AutoReqProv:    off
Version:        15.0.0
Release:        0
...
%description
Meta package for Server Xen role definition.
